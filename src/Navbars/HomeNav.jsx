    ...
    <React.Fragment>
      ...
      <div className="h-[100px] flex md:hidden justify-between items-center">
        <div className="flex justify-center items-center ml-[20px]">
          ...
          <div className="pt-4 select-none">
            <h1 className="text-[13.8182px] text-[#2B5EC0] pl-2 ">eDucura</h1>
            <h1 className="text-[4.14545px] capitalize ">
              ...promoting educational exelence
            </h1>
          </div>
        </div>
        <div className="">
          <ul
            className={
              (open ? "opacity-96" : "opacity-0") +
              " bg-[#f7f7f7] w-full h-auto  absolute transition-all duration-500 pt-5"
            }
          >
            <Link to="/">
        ...
        <div className="h-[100px] hidden md:flex justify-between items-center">
          ...
          <div className="flex justify-center items-center ml-[70px]">
            ...
            {/* head text */}
            <div className="pt-4 select-none">
              <h1 className="text-[20px] text-[#2B5EC0] pl-2 font-sans">
                eDucura
              </h1>
              <h1 className="text-[6px] capitalize font-sans">
                ...promoting educational exelence
              </h1>
            </div>
          </div>
      ...
      <div className="">
        <ul
          className={
            (open ? "opacity-96" : "opacity-0") +
            " bg-[#f7f7f7] h-[auto] w-full text-center absolute transition-all duration-500 py-48"
          }
        >
          <Link to="/">
            <li className="text-[16px] font-[400] p-6 text-xl font-sans">
              Home
            </li>
          </Link>
          <Link to="/about-us">
      ...
      <div className="h-[100px] hidden md:flex justify-between items-center">
        ...
        <div className="flex justify-center items-center ml-[70px]">
          ...
          {/* head text */}
          <div className="pt-4 select-none">
            <h1 className="text-[20px] text-[#2B5EC0] pl-2">eDucura</h1>
            <h1 className="text-[6px] capitalize">
              ...promoting educational exelence
            </h1>
          </div>
        </div>
