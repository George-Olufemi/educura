        ...
        <div className="h-[100px] hidden md:flex justify-between items-center">
            ...
            <div className="flex justify-center items-center relative">
                <ul className='flex space-x-7 mr-[68px]'>
                    <Link to='/'>
                        <li className="text-[16px] font-[400] hover:text-[#2B5EC0] transition-all">Home</li>
                    </Link>
                    <Link to='/about-us'>
                        <li className="text-[16px] font-[400] hover:text-[#2B5EC0] transition-all">About Us</li>
                    </Link>
                    <Link to='/contact-us'>
                        <li className="text-[16px] font-[400] hover:text-[#2B5EC0] transition-all">Contact Us</li>
                    </Link>
                </ul>
            </div>
        </div>
